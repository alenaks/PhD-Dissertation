...
\centering
\begin{tikzpicture}
\node[state, initial]  at (0,1) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (2,1) (a) {a:1};
\node[state]  at (4,2) (aa) {aa:$\varepsilon$};
\node[state]  at (4,0) (ab) {ab:$\varepsilon$};
\path[->] (e) edge[above] node{a:$\varepsilon$} (a)
...
\begin{tikzpicture}
\node[state, initial]  at (0,1) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (2,1) (a) {a:$\varepsilon$};
\node[state]  at (4,2) (aa) {aa:$\varepsilon$};
\node[state]  at (4,0) (ab) {ab:$\varepsilon$};
...
\path[->] (e) edge[above] node{a:uv} (a)
		  (a) edge[above] node{a:$\varepsilon$} (aa)
		  (a) edge[above] node{b:$\varepsilon$} (ab);
\end{tikzpicture}
%
\hspace{3em}
%
...
\begin{tikzpicture}
\small
\node[state, initial]  at (0,0) (e) {$\varepsilon:\perp$};
\node[state]  at (2,1) (a) {a:1};
...
\path[->] (e) edge[above] node{a:$\varepsilon$} (a)
		  (e) edge[above] node{b:$\varepsilon$} (b)
		  (a) edge[above] node{a:$\varepsilon$} (aa)
		  (a) edge[above] node{b:$\varepsilon$} (ab)
		  (aa) edge[above] node{a:$\varepsilon$} (aaa)
		  (ab) edge[above] node{a:$\varepsilon$} (aba);
\end{tikzpicture}
\end{center}
...
\node[state, initial]  at (0,0) (e) {$\varepsilon:\perp$};
\node[state]  at (2,1) (a) {a:1};
\node[state]  at (2,-1) (b) {b:$\varepsilon$};
\node[state]  at (4,2) (aa) {aa:1};
\node[state]  at (6,2) (aaa) {aaa:$\varepsilon$};
\node[state]  at (4,0) (ab) {ab:$\varepsilon$};
\node[state]  at (6,0) (aba) {aba:$\varepsilon$};
\path[->] (e) edge[above] node{a:$\varepsilon$} (a)
...
At first, only the initial state $q_\varepsilon$ is colored red.
...
In our example, two states are colored blue -- $q_a$ and $q_b$ -- since they can be reached from $q_\varepsilon$ in one step.
...
\begin{tikzpicture}
\small
\node[state, initial, red]  at (0,0) (e) {$\varepsilon:\perp$};
\node[state, blue]  at (2,1) (a) {a:1};
\node[state, blue]  at (2,-1) (b) {b:$\varepsilon$};
\node[state]  at (4,2) (aa) {aa:1};
\node[state]  at (6,2) (aaa) {aaa:$\varepsilon$};
\node[state]  at (4,0) (ab) {ab:$\varepsilon$};
\node[state]  at (6,0) (aba) {aba:$\varepsilon$};
...
\begin{tikzpicture}
\small
\node[state, initial, red]  at (0,1) (e) {$\varepsilon:\varepsilon$};
\node[state, blue]  at (2,1) (a) {a:1};
\node[state]  at (4,2) (aa) {aa:1};
\node[state]  at (6,2) (aaa) {aaa:$\varepsilon$};
\node[state]  at (4,0) (ab) {ab:$\varepsilon$};
...
\node[state]  at (6,2) (aaa) {aaa:$\varepsilon$};
\node[state, blue]  at (4,0) (ab) {ab:$\varepsilon$};
\node[state]  at (6,0) (aba) {aba:$\varepsilon$};
\path[->] (e) edge[above] node{a:$\varepsilon$} (a)
		  (e) edge[loop above] node{b:1} (e)
		  (a) edge[above] node{a:0} (aa)
...
\end{tikzpicture}
\end{center}
%\caption{After steps IV and V: folded $q_b$ into $q_\varepsilon$ and re-colored the states}
%\label{ostiastep45}
%\end{figure}

\paragraph{Step VI.}

We then try to merge $q_\varepsilon$ and $q_{aa}$, but it is not possible since they have different state outputs.
...
\path[->] (e) edge[above,, bend left] node{a:$\varepsilon$} (a)
		  (e) edge[loop above] node{b:1} (e)
		  (a) edge[loop above] node{a:0} (a)
		  (a) edge[above, bend left] node{b:01} (e);
\end{tikzpicture}
\end{center}
%\caption{After step VII: folded $q_{ab}$ into $q_{\varepsilon}$}
%\label{ostiastep7}
%\end{figure}
...
\begin{tikzpicture}
\small
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state] at (3,0) (a) {a:1};
\path[->] (e) edge[loop above] node{b:1} (e)
	(e) edge[above, bend left] node{a:$\varepsilon$} (a)
...
\path[->] (e) edge[above] node{H:$\varepsilon$} (H)
		(H) edge[left] node{H:$\varepsilon$} (HH)
		(H) edge[left] node{L:$\varepsilon$} (HL)
		(HH) edge[above] node{H:$\varepsilon$} (HHH)
		(HH) edge[above] node{L:$\varepsilon$} (HHL)
		(HL) edge[above] node{H:$\varepsilon$} (HLH)
		(HL) edge[above] node{L:$\varepsilon$} (HLL)
		(HLL) edge[above] node{H:$\varepsilon$} (HLLH);
\end{tikzpicture}
\end{center}

\paragraph{Step II.}
Then, as previously, let us push the state outputs from the leaf nodes closer to the initial state $q_\varepsilon$.
The resulting PTT is onward.

\begin{center}
\begin{tikzpicture}
\small
\node[state, initial]  at (0,0.25) (e) {$\varepsilon:\perp$};
\node[state]  at (2,0.25) (H) {H:$\perp$};
\node[state]  at (4,1.9) (HH) {HH:$\perp$};
\node[state]  at (7,2.7) (HHH) {HHH:$\varepsilon$};
\node[state]  at (7,1.1) (HHL) {HHL:$\varepsilon$};
\node[state]  at (4,-1.4) (HL) {HL:L};
\node[state]  at (7,-0.6) (HLH) {HLH:$\varepsilon$};
\node[state]  at (7,-2.2) (HLL) {HLL:LL};
\node[state]  at (10,-2.2) (HLLH) {HLLH:$\varepsilon$};
...
As previously, the initial state $q_\varepsilon$ is colored red, and the state $q_H$ available from $q_\varepsilon$ in one step is colored blue.

\begin{center}
\begin{tikzpicture}
\small
\node[state, initial, red]  at (0,0.25) (e) {$\varepsilon:\perp$};
...
\small
\node[state, initial, red]  at (0,0) (e) {$\varepsilon:\perp$};
\node[state, red]  at (2,0) (H) {H:$\varepsilon$};
\node[state]  at (1.3,1.9) (HHL) {HHL:$\varepsilon$};
\node[state, blue]  at (4,0) (HL) {HL:L};
\node[state]  at (7,0.8) (HLH) {HLH:$\varepsilon$};
\node[state]  at (7,-0.8) (HLL) {HLL:LL};
\node[state]  at (10,-0.8) (HLLH) {HLLH:$\varepsilon$};
\path[->] (e) edge[above, bend left] node{H:H} (H)
		(H) edge[below, bend left] node{H:$\varepsilon$} (e)
		(H) edge[above] node{L:$\varepsilon$} (HL)
...
The state $q_{HL}$ can be merged with neither $q_\varepsilon$ nor $q_{H}$ because the arrows reading $L$ bring the machine to states with different state outputs.
While the state output of $q_{HLL}$ is $LL$, $q_{HL}$ and $q_{HHL}$ output $L$ and $\varepsilon$, correspondingly.
Therefore $q_{HL}$ is colored red, and its children $q_{HLH}$ and $q_{HLL}$ are now blue.
Additionally, $q_{HHL}$ is also blue because it originates from the red state $q_\varepsilon$.
...
\node[state, initial, red]  at (0,0) (e) {$\varepsilon:\perp$};
\node[state, red]  at (2,0) (H) {H:$\varepsilon$};
\node[state, blue]  at (1.3,1.9) (HHL) {HHL:$\varepsilon$};
\node[state, red]  at (4,0) (HL) {HL:L};
\node[state, blue]  at (7,0.8) (HLH) {HLH:$\varepsilon$};
...
The state $q_{HLH}$ is merged with $q_\varepsilon$, and the only arrow incoming in $q_{HLH}$ from $q_{HL}$ is now targeting $q_\varepsilon$.
Since the state output of $q_{HLH}$ was $\varepsilon$ and the one of $q_\varepsilon$ was unknown, it is now re-defined as $\varepsilon$.

\begin{center}
\begin{tikzpicture}
\small
\node[state, initial, red]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state, red]  at (2,0) (H) {H:$\varepsilon$};
\node[state, blue]  at (1.3,1.9) (HHL) {HHL:$\varepsilon$};
\node[state, red]  at (4,0) (HL) {HL:L};
\node[state, blue]  at (6,0) (HLL) {HLL:LL};
\node[state]  at (9,0) (HLLH) {HLLH:$\varepsilon$};
\path[->] (e) edge[above, bend left] node{H:H} (H)
		(H) edge[below, bend left] node{H:$\varepsilon$} (e)
		(H) edge[above] node{L:$\varepsilon$} (HL)
		(e) edge[left] node{L:L} (HHL)
...
\node[state, blue]  at (9,0) (HLLH) {HLLH:$\varepsilon$};
\path[->] (e) edge[above, bend left] node{H:H} (H)
		(H) edge[below, bend left] node{H:$\varepsilon$} (e)
		(H) edge[above] node{L:$\varepsilon$} (HL)
		(e) edge[left] node{L:L} (HHL)
...
The state $q_{HLLH}$ is then merged with $q_\varepsilon$, and the arrow incoming in it from the state $q_{HLL}$ is re-directed.
...
Finally, the only remaining state $q_{HHL}$ is merged with $q_\varepsilon$, therefore, creating a loop that reads and writes $L$ on that state.
...
\small
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (2,0) (H) {H:$\varepsilon$};
...
\begin{tikzpicture}
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (3,-2) (x) {x:$\varepsilon$};
\node[state]  at (6,0) (xx) {xx:$\varepsilon$};
\node[state]  at (3,-4) (a) {a:$\varepsilon$};
...
\begin{tikzpicture}
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (3,1) (a) {a:$\varepsilon$};
\node[state]  at (3,-1) (o) {o:$\varepsilon$};
...
\begin{tikzpicture}
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (3,1.3) (o) {o:$\varepsilon$};
\node[state]  at (3,0) (u) {u:$\varepsilon$};
\node[state]  at (3,-1.3) (ee) {e:$\varepsilon$};
...
In particular, $q_\varepsilon$ corresponds to stems where the vowel and consonant values are $a$ and $p$; $q_o$ corresponds to $o$ and $p$; $q_b$ to $a$ and $b$; and, finally, $q_{ob}$ encodes stems with $o$ and $b$.
...
\begin{tikzpicture}
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (6,0) (ob) {ob:$\varepsilon$};
\node[state]  at (3,2) (o) {o:$\varepsilon$};
\node[state]  at (3,-2) (b) {b:$\varepsilon$};
...
\path[->] (o) edge[loop above] node{o:o, x:x} (o)
		...
		(e) edge[above] node{o:o} (o)
		(o) edge[below, bend left] node{a:$\varepsilon$} (oa)
		(oa) edge[below, bend left] node{o:ao, x:ax} (o)
		(a) edge[below, bend left] node{o:$\varepsilon$} (ao)
...
\begin{tikzpicture}
\node[state, initial]  at (0,0) (e) {$\varepsilon:\varepsilon$};
\node[state]  at (1.7, 0) (s) {s:$\varepsilon$};
\node[state]  at (3.4, 0) (si) {si:$\varepsilon$};
\node[state]  at (5.1, 0) (sim) {sim:$\varepsilon$};
\path[->] (e) edge[above, bend left] node{s:seen} (s)
		  (s) edge[above, bend left] node{i:$\varepsilon$} (si)
		  (si) edge[above, bend left] node{m:$\varepsilon$} (sim);
\end{tikzpicture}
\vspace{0.5em}
\begin{tikzpicture}
\node[state, initial]  at (8,0) (e1) {$\varepsilon:\varepsilon$};
\node[state]  at (8+1.7, 0) (s1) {s:$\varepsilon$};
\node[state]  at (8+3.4, 0) (si1) {si:$\varepsilon$};
\node[state]  at (8+5.1, 0) (sim1) {sim:$\varepsilon$};
...
\vspace{0.5em}
\begin{tikzpicture}
\node[state, initial]  at (0,-1.5) (e2) {$\varepsilon:\varepsilon$};
\node[state]  at (1.7, -1.5) (s2) {s:$\varepsilon$};
\node[state]  at (3.4, -1.5) (si2) {si:$\varepsilon$};
...
\vspace{0.5em}
\begin{tikzpicture}
\node[state, initial]  at (8,-1.5) (e3) {$\varepsilon:\varepsilon$};
\node[state]  at (8+1.7, -1.5) (s3) {s:$\varepsilon$};
\node[state]  at (8+3.4, -1.5) (si3) {si:$\varepsilon$};
\node[state]  at (8+5.1, -1.5) (sim3) {sim:$\varepsilon$};
\path[->] (e3) edge[above, bend left] node{s:$\varepsilon$} (s3)
		  (s3) edge[above, bend left] node{i:$\varepsilon$} (si3)
...
In all of them, a transition $q_\varepsilon\xrightarrow{\text{s:s}}q_{s}$ is fixed to only read and output $s$.
...
\path[->] (e1) edge[above, bend left] node{s:s} (s1)
		  (s1) edge[above, bend left] node{i:$\varepsilon$} (si1)
