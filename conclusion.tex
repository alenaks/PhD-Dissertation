...
The performance of the algorithms can be improved by adding probabilities and linguistic notions such as features and natural classes.
...
\paragraph{Explaining the impossible}
